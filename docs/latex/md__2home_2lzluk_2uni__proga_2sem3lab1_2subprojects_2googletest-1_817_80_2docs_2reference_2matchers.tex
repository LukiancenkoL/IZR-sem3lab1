...
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers}{}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers}\index{Matchers Reference@{Matchers Reference}}
\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md256}%
\Hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md256}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md257}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md258}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md258}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_FpMatchers}{}\doxysection{\texorpdfstring{Floating-\/\+Point Matchers}{Floating-Point Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md259}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md259}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md260}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md260}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T\texorpdfstring{$\ast$}{*} buffer,         int len)} -- see \doxysectlink{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_MultiArgMatchers}{Multi-\/argument Matchers}{1}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md261}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md261}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md262}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md262}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md263}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md263}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_MultiArgMatchers}{}\doxysection{\texorpdfstring{Multi-\/argument Matchers}{Multi-argument Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md264}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md264}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md265}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md265}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_MatchersAsPredicatesCheat}{}\doxysection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md266}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md__2home_2lzluk_2uni__proga_2sem3lab1_2subprojects_2googletest-1_817_80_2docs_2reference_2matchers_autotoc_md266}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
